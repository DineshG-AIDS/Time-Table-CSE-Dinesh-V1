...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    validatePhone();
    if (
      (formData.role === "Admin" && secretCode === "D<%0") ||
      ...
      {showSignupContent ? (
        <div className="p-10 ">
          <p className="heading">
            ...
            <img src={Logo} className="w-32 pb-6" alt="" />
          </p>
          <form onSubmit={handleSubmit} className="flex flex-col">
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              <div>
                ...
                >
                  ...
                  <option value="Professor (Institute Level Responsibility)">
                    Professor (Institute Level Responsibility)
                  </option>
                  <option value="Professor">Professor</option>
                  <option value="Associate Professor (Institute Level Responsibility)">
                    Associate Professor (Institute Level Responsibility)
                  </option>
                  <option value="Associate Professor">
                    Associate Professor
                  </option>
                  <option value="Assistant Professor (Institute Level Responsibility)">
                    Assistant Professor (Institute Level Responsibility)
                  </option>
                  <option value="Assistant Professor">
                    Assistant Professor
                  </option>
                  <option value="Research Faculty(CFRD Responsibilities)">
                    Research Faculty(CFRD Responsibilities)
                  </option>
                </select>
              </div>
              <div>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              ...
              {showClass && (
                <div>
                  <label htmlFor="classname">Class Name eg. I-CSE-B</label>
                  <br />
                  <input
                    className="input"
                    type="text"
